...
export default function PickleballSocialProof() {
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="mx-auto mt-8 max-w-lg text-sm leading-7 text-white/45 sm:text-base">
            Meet the people who bring the court to life.
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-5 lg:grid-cols-1">
            ...
            >
              ...
              <img
                src="/match2.jpeg"
                alt="AFTERRMATCH pickleball community"
                loading="lazy"
                className="
                  absolute
                  inset-0
            ...
            >
              ...
              <img
                src="/match1.jpg"
                alt="Pickleball players at AFTERRMATCH"
                loading="lazy"
                className="
                  absolute
                  inset-0
