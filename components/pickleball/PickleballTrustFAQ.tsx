...
const trustPoints = [
  {
    ...
    title: "Clear Booking",
    description:
      "Choose your preferred time and reserve your court through a simple booking experience.",
...
const faqs = [
  {
    question: "Is pickleball suitable for beginners?",
    answer:
      "Yes. Pickleball is easy to learn and is a great option whether you're playing for the first time or already enjoy the game.",
  },
  {
    question: "Do I need to bring my own paddle?",
    answer:
      "You can bring your own equipment. If AFTERRMATCH provides or rents equipment, the available options and pricing can be mentioned here.",
  },
  {
    question: "Can I come with friends?",
    answer:
      "Absolutely. Pickleball is a social game and is ideal for playing with friends, family or your wider group.",
  },
  {
    question: "How do I book a court?",
    answer:
      "Select your preferred date and time from the booking page and complete your reservation.",
  },
  {
    question: "How much does a session cost?",
    answer:
      "Please check the current AFTERRMATCH booking page for the applicable court and session pricing.",
  },
  {
    question: "Can I cancel my booking?",
    answer:
      "Cancellation and refund eligibility depend on the applicable AFTERRMATCH cancellation policy. Please review the policy before confirming your booking.",
  },
];

export default function PickleballTrustFAQ() {
