...
const points = [
  {
    ...
    title: "Fun & Energy",
    description:
      "A lively environment where every session feels social, active and exciting.",
  },
  {
    number: "02",
    title: "Beginner Friendly",
    description:
      "You don't need to be an expert. Pick up a paddle and enjoy the game from your very first session.",
  },
  {
    number: "03",
  ...
  },
  {
    ...
    title: "Just Have Fun",
    description:
      "Come for a casual game, stay for the energy and leave wanting another round.",
  },
];

export default function PickleballExperience() {
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-9 grid gap-8 md:grid-cols-[1fr_260px] md:items-end">
          ...
          <p
            ...
            `}
          >
            Everything comes together to make your time on the
            court feel effortless, social and worth coming back to.
          </p>
