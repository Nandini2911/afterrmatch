...
const experiences = [
  {
    ...
    description:
      "A premium gaming environment where every session feels immersive, social and exciting.",
    tag: "Feel the game",
  },
  {
    ...
    title: "Easy to Start",
    description:
      "You don't need to be an expert. Pick up the controller and jump into a game at your own pace.",
    tag: "Start anywhere",
  },
  {
    ...
    description:
      "Play with friends, challenge each other and turn a simple session into a great memory.",
    tag: "Better together",
  },
  {
    ...
    title: "Easy Booking",
    description:
      "Choose your preferred time and reserve your PS5 session without unnecessary hassle.",
    tag: "Your time",
  },
  {
        ...
        >
          ...
          >
            ...
            >
              ...
              time on the PS5 setup feel effortless,
