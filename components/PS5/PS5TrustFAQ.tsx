...
const trustPoints = [
  {
    ...
    title: "Easy Booking",
    description:
      "Choose your preferred time and reserve your PS5 through a simple booking experience.",
  ...
  },
  {
    ...
    title: "Easy to Start",
    description:
      "You don't need to be an experienced gamer. Pick up the controller and play at your own pace.",
...
const faqs = [
  {
    question: "Is PS5 suitable for beginners?",
    answer:
      "Yes. PS5 is great for beginners and experienced gamers alike, with a huge range of games to choose from.",
  },
  {
    question: "Do I need to bring my own controller?",
    answer:
      "You can bring your own controller if preferred. If controllers or accessories are provided, the available options can be mentioned here.",
  },
  {
    question: "Can I come with friends?",
    answer:
      "Absolutely. PS5 is perfect for playing with friends, family or your wider group.",
  },
  {
    question: "How do I book a PS5?",
    answer:
      "Select your preferred date and time from the booking page and complete your PS5 reservation.",
  },
  {
    question: "How much does a PS5 session cost?",
    answer:
      "Please check the current booking page for the applicable PS5 session pricing.",
  },
  {
    question: "Can I cancel my booking?",
    answer:
      "Cancellation and refund eligibility depend on the applicable cancellation policy. Please review the policy before confirming your booking.",
  },
];

export default function PS5TrustFAQ() {
