...
export default function PS5SocialProof() {
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="mx-auto mt-8 max-w-lg text-sm leading-7 text-white/45 sm:text-base">
            Meet the people who bring the PS5 setup to life.
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-5 lg:grid-cols-1">
            ...
            >
              ...
              <img
                src="/ps5match2.jpeg"
                alt="PS5 EXPERIENCE PS5 community"
                loading="lazy"
                className="
                  absolute
                  inset-0
            ...
            >
              ...
              <img
                src="/ps5match1.jpeg"
                alt="PS5 players at PS5 EXPERIENCE"
                loading="lazy"
                className="
                  absolute
                  inset-0
