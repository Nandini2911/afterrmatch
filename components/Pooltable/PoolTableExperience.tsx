...
const points = [
  {
    ...
    title: "Precision",
    description:
      "Every angle matters. Take your time, read the table and make your shot count.",
  },
  {
    number: "02",
    title: "Good Competition",
    description:
      "Challenge your friends, sharpen your game and enjoy the thrill of the next shot.",
  },
  {
    number: "03",
    title: "Bring Your People",
    description:
      "The best games become better memories when you share them with the right people.",
  },
  {
    number: "04",
    title: "Easy Booking",
    description:
      "Choose your preferred time and reserve your session without unnecessary hassle.",
  },
  {
    number: "05",
    title: "Just Play",
    description:
      "Come for the game, stay for the atmosphere and leave ready for another round.",
  },
];
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-9 grid gap-8 md:grid-cols-[1fr_260px] md:items-end">
          ...
          <p
            ...
            `}
          >
            Everything comes together to make your time around
            the table feel effortless, social and worth coming back to.
          </p>
